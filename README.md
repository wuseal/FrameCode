...
#### 1.7.4
1.Gson取消对返回json数据的Html Encode

#### 1.7.2
1.修复NetErrorView在同一布局下存在多个的时候的NetErrorView的错误逻辑
...
<code>compile 'com.dahanis:foundation:1.7.4'</code>
<h4>像上面那样直接在gradle中的dependencies {...}的大括号内加入<br>
compile 'com.dahanis:foundation:1.7.4'
即可完成引入</h4>

##### 集成步骤：
* 先在build.gradle文件中引入<code>compile 'com.dahanis:foundation:1.7.4'</code>
